...
},{"./com/Hall":4,"./ui/layaMaxUI":28}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./HuoDong":5,"./KeFu":6,"./SetUi":8,"./UiMainager":9,"./UserInfo":10,"./chongzhi/ChongZhi":11,"./control/TabList":13,"./login/LoginUi":14,"./login/RegisterUi":15,"./mail/MailUi":17,"./notice/Notice":18,"./notice/NoticeMsg":19,"./tixian/TiXianUi":21,"./tuiguang/TuiGuang":25,"./xima/XiMa":26}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./BasePanel":3,"./control/TabList":13}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var BasePanel_1 = require("./BasePanel");
...
var MiniLoadingUi = /** @class */ (function (_super) {
    ...
    function MiniLoadingUi() {
        return _super.call(this, 'ui.MiniLaodingUI') || this;
    }
...
},{"./MiniLoadingUi":7}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var BasePanel_1 = require("./BasePanel");
var TabList_1 = require("./control/TabList");
var UserInfo = /** @class */ (function (_super) {
    ...
    UserInfo.prototype.showVIP = function () {
        this._info.close();
        this._touzu.close();
...
exports.Info = Info;
var TouZuHistroy = /** @class */ (function () {
    function TouZuHistroy(res) {
        this._box = res['b_touZhu'];
        this._box.visible = false;
        this._tab = new TabList_1.default(res['list_tab1']);
        this._tab.tabChangeHander = Laya.Handler.create(this, this.onTabChange, null, false);
        this._tab.dataSource = [
    ...
    TouZuHistroy.prototype.close = function () {
        this._box.visible = false;
    };
    return TouZuHistroy;
}());
...
},{"./BasePanel":3,"./control/TabList":13}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BasePanel":3,"./ChongZhiHistroy":12}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BaseHistroy":2}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../UiMainager":9}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var UiMainager_1 = require("../UiMainager");
var RegisterUi = /** @class */ (function (_super) {
    ...
    RegisterUi.prototype.reciveNetMsg = function (msg, data) {
        if (msg == gamelib.GameMsg.Register) {
            UiMainager_1.g_uiMgr.showMiniLoading();
            if (data.retCode == 0) {
                g_net.request(gamelib.GameMsg.Login, { un: this._res['txt_name'].text, pw: this._res["txt_pwd1"].text });
                this.close();
            }
            else {
                UiMainager_1.g_uiMgr.showTip(data.retMsg);
...
},{"../UiMainager":9}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./MailInfo":16}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BasePanel":3,"./TiXianHistroy":20}],22:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var BaseHistroy_1 = require("../BaseHistroy");
...
},{"../BaseHistroy":2}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BaseHistroy":2}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BasePanel":3,"../UiMainager":9,"../control/TabList":13,"./FanYongList":22,"./GetYongJin":23,"./LingQuHistroy":24}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../BasePanel":3,"./XiMaHistroy":27}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var BaseHistroy_1 = require("../BaseHistroy");
...
(function (ui) {
    ...
    var RegisterUiUI = /** @class */ (function (_super) {
        ...
        RegisterUiUI.uiView = { "type": "Dialog", "props": { "width": 1096, "height": 660 }, "compId": 2, "child": [{ "type": "Image", "props": { "top": 0, "skin": "bgs/ic_register_bg.png", "right": 0, "left": 0, "bottom": 0 }, "compId": 3 }, { "type": "Button", "props": { "y": 0, "x": 998, "var": "btn_close", "stateNum": 1, "skin": "btns/ic_close.png" }, "compId": 4 }, { "type": "Button", "props": { "y": 540, "var": "btn_ok", "stateNum": 1, "skin": "btns/ic_register_dialog.png", "scaleY": 0.5, "scaleX": 0.5, "centerX": 0 }, "compId": 5 }, { "type": "Label", "props": { "y": 178, "x": 210, "text": "账号", "fontSize": 30, "color": "#FFFFFF", "bold": true }, "compId": 6 }, { "type": "Image", "props": { "y": 169, "x": 345, "width": 545, "skin": "comp/ic_input_bg.png", "sizeGrid": "14,32,11,23", "height": 48 }, "compId": 7, "child": [{ "type": "TextInput", "props": { "y": 7, "x": 11, "width": 529, "var": "txt_name", "type": "text", "prompt": "请输入您的账号", "height": 36, "fontSize": 30, "color": "#d6c09a" }, "compId": 8 }] }, { "type": "Label", "props": { "y": 261, "x": 210, "text": "密码", "fontSize": 30, "color": "#FFFFFF", "bold": true }, "compId": 9 }, { "type": "Image", "props": { "y": 252, "x": 345, "width": 545, "skin": "comp/ic_input_bg.png", "sizeGrid": "14,32,11,23", "height": 48 }, "compId": 10, "child": [{ "type": "TextInput", "props": { "y": 7, "x": 11, "width": 529, "var": "txt_pwd1", "type": "password", "prompt": "请输入您的密码", "height": 36, "fontSize": 30, "color": "#d6c09a" }, "compId": 11 }] }, { "type": "Label", "props": { "y": 344, "x": 210, "text": "确认密码", "fontSize": 30, "color": "#FFFFFF", "bold": true }, "compId": 12 }, { "type": "Image", "props": { "y": 335, "x": 344, "width": 545, "skin": "comp/ic_input_bg.png", "sizeGrid": "14,32,11,23", "height": 48 }, "compId": 13, "child": [{ "type": "TextInput", "props": { "y": 7, "x": 11, "width": 529, "var": "txt_pwd2", "type": "text", "prompt": "请输入持卡人姓名", "height": 36, "fontSize": 30, "color": "#d6c09a" }, "compId": 14 }] }, { "type": "Label", "props": { "y": 427, "x": 210, "text": "提款密码", "fontSize": 30, "color": "#FFFFFF", "bold": true }, "compId": 15 }, { "type": "Image", "props": { "y": 418, "x": 345, "width": 545, "skin": "comp/ic_input_bg.png", "sizeGrid": "14,32,11,23", "height": 48 }, "compId": 16, "child": [{ "type": "TextInput", "props": { "y": 7, "x": 11, "width": 529, "type": "number", "prompt": "请输入提款密码,6位纯数字", "height": 36, "fontSize": 30, "color": "#d6c09a" }, "compId": 17 }] }], "loadList": ["bgs/ic_register_bg.png", "btns/ic_close.png", "btns/ic_register_dialog.png", "comp/ic_input_bg.png"], "loadList3D": [] };
        return RegisterUiUI;
    }(Dialog));
    ...
    var UserInfoUI = /** @class */ (function (_super) {
        ...
        UserInfoUI.uiView = { "type": "View", "props": { "width": 1280, "height": 720 }, "compId": 2, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "top": 0, "skin": "bgs/ic_qipai_bg.png", "right": 0, "left": 0, "bottom": 0 }, "compId": 115 }, { "type": "Image", "props": { "y": 10, "x": 10, "skin": "comp/dactivity_nav_left.png" }, "compId": 99 }, { "type": "Box", "props": { "var": "b_info", "top": 130, "right": 10, "left": 303, "height": 590 }, "compId": 16, "child": [{ "type": "Panel", "props": { "y": 0, "x": 0, "width": 971, "var": "p_1", "sizeGrid": "2,10,2,10", "height": 584 }, "compId": 112, "child": [{ "type": "Box", "props": { "y": 0, "x": 0, "width": 969, "height": 724 }, "compId": 113, "child": [{ "type": "Image", "props": { "y": 0, "width": 969, "skin": "bgs/ic_pc_title.png", "right": 0, "left": 0, "height": 48 }, "compId": 114, "child": [{ "type": "Image", "props": { "x": 23, "skin": "icons/ic_dot.png", "centerY": 0 }, "compId": 21 }, { "type": "Label", "props": { "x": 76, "text": "等级特权", "fontSize": 24, "color": "#eaa65a", "centerY": 0 }, "compId": 20 }] }, { "type": "Image", "props": { "y": 90, "x": 61, "width": 130, "var": "img_vip", "skin": "icons/ic_pc_vip1.png", "height": 80 }, "compId": 116 }, { "type": "Label", "props": { "y": 98, "x": 191, "text": "当前会员等级:VIP1", "fontSize": 20, "color": "#eaa65a" }, "compId": 117 }, { "type": "Image", "props": { "y": 128, "x": 191, "var": "vip_1", "skin": "icons/ic_vip_1.png", "skewX": 0, "scaleY": 0.5, "scaleX": 0.5 }, "compId": 118 }, { "type": "Image", "props": { "y": 129, "x": 756, "var": "vip_2", "skin": "icons/ic_vip_1.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 127 }, { "type": "Image", "props": { "y": 128, "x": 251, "width": 505, "var": "img_press_1", "skin": "comp/progress_load_drawable.png", "sizeGrid": "2,10,2,10" }, "compId": 128 }, { "type": "Image", "props": { "y": 128, "x": 254, "width": 502, "var": "img_press_2", "skin": "comp/progress_load_bg_select.png", "sizeGrid": "0,25,0,18", "height": 27 }, "compId": 129 }, { "type": "Label", "props": { "y": 164, "x": 254, "text": "还差10000.00打码升级到VIP2", "color": "#FFFFFF" }, "compId": 130 }, { "type": "Image", "props": { "y": 190, "skin": "bgs/vip_title_bg.png", "right": 0, "left": 0, "height": 48 }, "compId": 131, "child": [{ "type": "Label", "props": { "x": 257, "text": "尊敬的VIP1会员，您享受以下权益", "fontSize": 30, "color": "#eaa65a", "centerY": 0, "centerX": 0 }, "compId": 132 }] }, { "type": "Image", "props": { "y": 190, "x": 0, "skin": "icons/ic_up_vip1.png", "scaleY": 0.5, "scaleX": 0.5, "name": "img_vip_now" }, "compId": 133 }, { "type": "Image", "props": { "y": 190, "x": 860, "skin": "icons/ic_next_vip2.png", "scaleY": 0.5, "scaleX": 0.5, "name": "img_vip_next" }, "compId": 135 }, { "type": "Box", "props": { "y": 251, "x": 25, "name": "b1" }, "compId": 143, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 338, "skin": "bgs/pc_quanyi_bg.png", "scaleY": 0.6, "scaleX": 0.6, "height": 400 }, "compId": 136 }, { "type": "Image", "props": { "y": 8, "x": 40.103515625, "skin": "icons/rights_1.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 141 }, { "type": "Label", "props": { "y": 107, "x": 63.09824218749999, "text": "0.00元", "name": "txt_value", "fontSize": 26, "color": "#eaa65a" }, "compId": 142 }, { "type": "Label", "props": { "y": 149, "x": 53.39999999999999, "text": "当前等级不可领取", "name": "txt_status", "color": "#6b6262" }, "compId": 144 }, { "type": "Button", "props": { "y": 189, "x": 53.39999999999999, "stateNum": 1, "skin": "btns/ic_act_no.png", "scaleY": 0.3, "scaleX": 0.3, "name": "btn_ok" }, "compId": 145 }] }, { "type": "Box", "props": { "y": 251, "x": 269, "name": "b2" }, "compId": 146, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 338, "skin": "bgs/pc_quanyi_bg.png", "scaleY": 0.6, "scaleX": 0.6, "height": 400 }, "compId": 147 }, { "type": "Image", "props": { "y": 8, "x": 40.103515625, "skin": "icons/rights_3.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 148 }, { "type": "Label", "props": { "y": 107, "x": 63.09824218749999, "text": "0.00元", "name": "txt_value", "fontSize": 26, "color": "#eaa65a" }, "compId": 149 }, { "type": "Label", "props": { "y": 149, "x": 53.39999999999999, "text": "当前等级不可领取", "name": "txt_status", "color": "#6b6262" }, "compId": 150 }, { "type": "Button", "props": { "y": 189, "x": 53.39999999999999, "stateNum": 1, "skin": "btns/ic_act_no.png", "scaleY": 0.3, "scaleX": 0.3, "name": "btn_ok" }, "compId": 151 }] }, { "type": "Box", "props": { "y": 251, "x": 513, "name": "b3" }, "compId": 152, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 338, "skin": "bgs/pc_quanyi_bg.png", "scaleY": 0.6, "scaleX": 0.6, "height": 400 }, "compId": 153 }, { "type": "Image", "props": { "y": 8, "x": 40.103515625, "skin": "icons/rights_2.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 154 }, { "type": "Label", "props": { "y": 107, "x": 63.09824218749999, "text": "0.00元", "name": "txt_value", "fontSize": 26, "color": "#eaa65a" }, "compId": 155 }, { "type": "Label", "props": { "y": 149, "x": 53.39999999999999, "text": "当前等级不可领取", "name": "txt_status", "color": "#6b6262" }, "compId": 156 }, { "type": "Button", "props": { "y": 189, "x": 53.39999999999999, "stateNum": 1, "skin": "btns/ic_act_no.png", "scaleY": 0.3, "scaleX": 0.3, "name": "btn_ok" }, "compId": 157 }] }, { "type": "Box", "props": { "y": 251, "x": 758, "name": "b4" }, "compId": 164, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 338, "skin": "bgs/pc_quanyi_bg.png", "scaleY": 0.6, "scaleX": 0.6, "height": 400 }, "compId": 165 }, { "type": "Image", "props": { "y": 8, "x": 40.103515625, "skin": "icons/rights_4.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 166 }, { "type": "Label", "props": { "y": 107, "x": 63.09824218749999, "text": "0.00元", "name": "txt_value", "fontSize": 26, "color": "#eaa65a" }, "compId": 167 }, { "type": "Label", "props": { "y": 149, "x": 53.39999999999999, "text": "当前等级不可领取", "name": "txt_status", "color": "#6b6262" }, "compId": 168 }, { "type": "Button", "props": { "y": 189, "x": 63.09824218749999, "stateNum": 1, "skin": "btns/ic_xima_shoudongxima.png", "scaleY": 0.3, "scaleX": 0.3, "name": "btn_ok" }, "compId": 169 }] }, { "type": "Image", "props": { "y": 515, "width": 969, "skin": "bgs/ic_pc_title.png", "right": 0, "left": 0, "height": 48 }, "compId": 176, "child": [{ "type": "Image", "props": { "x": 23, "skin": "icons/ic_dot.png", "centerY": 0 }, "compId": 177 }, { "type": "Label", "props": { "x": 76, "text": "基础信息", "fontSize": 24, "color": "#eaa65a", "centerY": 0 }, "compId": 178 }, { "type": "Button", "props": { "y": 10, "x": 893, "stateNum": 1, "skin": "btns/ic_edit.png", "scaleY": 0.5, "scaleX": 0.5, "name": "btn_xg1" }, "compId": 187 }] }, { "type": "Box", "props": { "y": 597, "x": 54, "name": "b_info" }, "compId": 182, "child": [{ "type": "Box", "props": { "y": 0, "x": 0 }, "compId": 179, "child": [{ "type": "Image", "props": { "y": -17, "x": -18, "width": 98, "skin": "comp/img_touxiangMask.png", "sizeGrid": "45,45,45,45", "renderType": "mask", "height": 98 }, "compId": 180 }, { "type": "Image", "props": { "y": 0, "x": 0, "var": "img_head", "skin": "comp/dindex_index_icon.png" }, "compId": 181 }] }, { "type": "Label", "props": { "y": 0, "x": 103, "text": "账号：", "fontSize": 22, "color": "#eaa65a" }, "compId": 183 }, { "type": "Label", "props": { "y": 0, "x": 168, "text": "玩家账号", "name": "txt_account", "fontSize": 22, "color": "#FFFFFF" }, "compId": 184 }, { "type": "Label", "props": { "y": 0, "x": 297, "text": "昵称", "fontSize": 22, "color": "#eaa65a" }, "compId": 185 }, { "type": "TextInput", "props": { "y": 0, "x": 361, "width": 128, "text": "玩家账号", "skin": "comp/ic_input_bg.png", "name": "txt_nickName", "height": 27, "fontSize": 22, "color": "#FFFFFF" }, "compId": 186 }, { "type": "Label", "props": { "y": 50, "x": 103, "text": "姓名：", "fontSize": 22, "color": "#eaa65a" }, "compId": 188 }, { "type": "TextInput", "props": { "y": 46, "x": 168, "width": 128, "text": "玩家账号", "skin": "comp/ic_input_bg.png", "name": "txt_name", "height": 31, "fontSize": 22, "color": "#FFFFFF" }, "compId": 189 }, { "type": "Label", "props": { "y": 51, "x": 297, "text": "性别：", "fontSize": 22, "color": "#eaa65a" }, "compId": 190 }, { "type": "TextInput", "props": { "y": 48, "x": 363, "width": 128, "text": "男", "skin": "comp/ic_input_bg.png", "name": "txt_sex", "height": 29, "fontSize": 22, "color": "#FFFFFF" }, "compId": 191 }, { "type": "Label", "props": { "y": 52, "x": 507, "text": "生日：", "fontSize": 22, "color": "#eaa65a" }, "compId": 192 }, { "type": "TextInput", "props": { "y": 52, "x": 572, "width": 128, "text": "10-10", "skin": "comp/ic_input_bg.png", "name": "txt_day", "height": 25, "fontSize": 22, "color": "#FFFFFF" }, "compId": 193 }] }, { "type": "Image", "props": { "y": 700, "skin": "bgs/ic_pc_title.png", "right": 0, "left": 0, "height": 48 }, "compId": 194, "child": [{ "type": "Image", "props": { "x": 23, "skin": "icons/ic_dot.png", "centerY": 0 }, "compId": 195 }, { "type": "Label", "props": { "x": 76, "text": "联系方式", "fontSize": 24, "color": "#eaa65a", "centerY": 0 }, "compId": 196 }, { "type": "Button", "props": { "y": 10, "x": 893, "stateNum": 1, "skin": "btns/ic_edit.png", "scaleY": 0.5, "scaleX": 0.5, "name": "btn_xg2" }, "compId": 197 }] }, { "type": "Label", "props": { "y": 779, "x": 68.5, "text": "邮箱：", "fontSize": 22, "color": "#eaa65a" }, "compId": 198 }, { "type": "TextInput", "props": { "y": 775, "x": 135, "width": 128, "text": "玩家账号", "skin": "comp/ic_input_bg.png", "name": "txt_mail", "height": 31, "fontSize": 22, "color": "#FFFFFF" }, "compId": 199 }, { "type": "Label", "props": { "y": 779, "x": 614.4, "text": "电话：", "fontSize": 22, "color": "#eaa65a" }, "compId": 200 }, { "type": "TextInput", "props": { "y": 775, "x": 683, "width": 128, "text": "玩家账号", "skin": "comp/ic_input_bg.png", "name": "txt_tel", "height": 31, "fontSize": 22, "color": "#FFFFFF" }, "compId": 201 }, { "type": "Label", "props": { "y": 857, "x": 69, "text": "QQ：", "fontSize": 22, "color": "#eaa65a" }, "compId": 202 }, { "type": "TextInput", "props": { "y": 853, "x": 137, "width": 128, "text": "玩家账号", "skin": "comp/ic_input_bg.png", "name": "txt_qq", "height": 31, "fontSize": 22, "color": "#FFFFFF" }, "compId": 203 }, { "type": "Label", "props": { "y": 862, "x": 617, "text": "微信：", "fontSize": 22, "color": "#eaa65a" }, "compId": 204 }, { "type": "TextInput", "props": { "y": 858, "x": 684, "width": 128, "text": "玩家账号", "skin": "comp/ic_input_bg.png", "name": "txt_wx", "height": 31, "fontSize": 22, "color": "#FFFFFF" }, "compId": 205 }] }] }] }, { "type": "Box", "props": { "var": "b_touZhu", "top": 130, "right": 10, "left": 303, "height": 590 }, "compId": 17, "child": [{ "type": "Image", "props": { "y": 0, "width": 967, "skin": "bgs/ic_gathering_bg.png", "right": 0, "left": 0, "height": 584 }, "compId": 212 }, { "type": "List", "props": { "y": 153, "width": 967, "var": "list_1", "vScrollBarSkin": "comp/vscroll.png", "right": 0, "left": 0, "height": 429 }, "compId": 46, "child": [{ "type": "Box", "props": { "name": "render" }, "compId": 47, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 957, "skin": "bgs/dpersonalcenter_gerenzhonxinjilubg1.png", "sizeGrid": "14,13,10,13", "name": "bg_1", "height": 77 }, "compId": 48 }, { "type": "Image", "props": { "y": 0, "x": 0, "width": 958, "skin": "bgs/dpersonalcenter_gerenzhonxinjilubg2.png", "sizeGrid": "14,13,10,13", "name": "bg_2", "height": 77 }, "compId": 49 }, { "type": "Label", "props": { "y": 26, "x": 0, "width": 188, "text": "#f4ce7f", "name": "txt_1", "height": 26, "fontSize": 26, "color": "#f4ce7f", "align": "center" }, "compId": 50 }, { "type": "Label", "props": { "y": 26, "x": 200, "width": 188, "text": "#f4ce7f", "name": "txt_2", "height": 26, "fontSize": 26, "color": "#f4ce7f", "align": "center" }, "compId": 51 }, { "type": "Label", "props": { "y": 26, "x": 387, "width": 191, "text": "#f4ce7f", "name": "txt_3", "height": 26, "fontSize": 26, "color": "#f4ce7f", "align": "center" }, "compId": 52 }, { "type": "Label", "props": { "y": 26, "x": 585, "width": 192, "text": "#f4ce7f", "name": "txt_4", "height": 26, "fontSize": 26, "color": "#f4ce7f", "align": "center" }, "compId": 53 }, { "type": "Label", "props": { "y": 26, "x": 777, "width": 139, "text": "#f4ce7f", "name": "txt_5", "height": 26, "fontSize": 26, "color": "#f4ce7f", "align": "left" }, "compId": 54 }] }] }, { "type": "List", "props": { "y": 0, "x": 0, "width": 926, "var": "list_tab1", "spaceX": 5, "repeatY": 1, "height": 58 }, "compId": 206, "child": [{ "type": "Box", "props": { "renderType": "render" }, "compId": 208, "child": [{ "type": "Image", "props": { "skin": "btns/ic_pc_grbb_tab.png", "scaleY": 0.5, "scaleX": 0.5, "name": "bg_normal" }, "compId": 209 }, { "type": "Image", "props": { "y": 0, "x": 0, "skin": "btns/ic_pc_grbb_tab_pressed.png", "scaleY": 0.5, "scaleX": 0.5, "name": "bg_selected" }, "compId": 210 }, { "type": "Label", "props": { "y": 15, "x": 18.75, "text": "棋牌投注记录", "name": "txt_label", "fontSize": 24 }, "compId": 211 }] }] }, { "type": "Label", "props": { "y": 72, "x": 12, "text": "派彩时间", "fontSize": 24, "color": "#ffffff" }, "compId": 213 }, { "type": "Image", "props": { "y": 68.5, "x": 125.5, "var": "btn_time", "skin": "bgs/ic_pc_edit.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 214 }, { "type": "Label", "props": { "y": 72, "x": 147, "var": "txt_time1", "text": "派彩时间", "fontSize": 24, "color": "#ffffff" }, "compId": 215 }, { "type": "Label", "props": { "y": 72, "x": 671, "text": "游戏平台", "fontSize": 24, "color": "#ffffff" }, "compId": 216 }, { "type": "Image", "props": { "y": 67, "x": 783, "var": "btn_platfrom", "skin": "bgs/ic_pc_edit.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 217 }, { "type": "Label", "props": { "y": 71, "x": 805, "var": "txt_platfrom", "text": "全部平台", "fontSize": 24, "color": "#ffffff" }, "compId": 218 }, { "type": "Image", "props": { "y": 113.5, "x": 0, "width": 191, "skin": "bgs/ic_pc_pop_wind.png", "sizeGrid": "2,2,2,2", "height": 40 }, "compId": 219, "child": [{ "type": "Label", "props": { "text": "派彩时间", "right": 0, "left": 0, "height": 26, "fontSize": 26, "color": "#f3d667", "centerY": 0, "align": "center" }, "compId": 220 }] }, { "type": "Image", "props": { "y": 113.5, "x": 194, "width": 191, "skin": "bgs/ic_pc_pop_wind.png", "sizeGrid": "2,2,2,2", "height": 40 }, "compId": 221, "child": [{ "type": "Label", "props": { "text": "注单号", "right": 0, "left": 0, "height": 26, "fontSize": 26, "color": "#f3d667", "centerY": 0, "align": "center" }, "compId": 222 }] }, { "type": "Image", "props": { "y": 113, "x": 388, "width": 191, "skin": "bgs/ic_pc_pop_wind.png", "sizeGrid": "2,2,2,2", "height": 40 }, "compId": 223, "child": [{ "type": "Label", "props": { "text": "游戏名称", "right": 0, "left": 0, "height": 26, "fontSize": 26, "color": "#f3d667", "centerY": 0, "align": "center" }, "compId": 224 }] }, { "type": "Image", "props": { "y": 113, "x": 582, "width": 191, "skin": "bgs/ic_pc_pop_wind.png", "sizeGrid": "2,2,2,2", "height": 40 }, "compId": 225, "child": [{ "type": "Label", "props": { "text": "投注金额", "right": 0, "left": 0, "height": 26, "fontSize": 26, "color": "#f3d667", "centerY": 0, "align": "center" }, "compId": 226 }] }, { "type": "Image", "props": { "y": 113.5, "x": 776, "width": 191, "skin": "bgs/ic_pc_pop_wind.png", "sizeGrid": "2,2,2,2", "height": 40 }, "compId": 227, "child": [{ "type": "Label", "props": { "text": "已派奖", "right": 0, "left": 0, "height": 26, "fontSize": 26, "color": "#f3d667", "centerY": 0, "align": "center" }, "compId": 228 }] }, { "type": "Label", "props": { "y": 0, "x": 0, "var": "txt_tips1", "text": "暂无数据", "fontSize": 28, "color": "#ffffff", "centerY": 101, "centerX": 0 }, "compId": 229, "child": [{ "type": "Image", "props": { "y": -94, "x": -10, "skin": "comp/bg_data_null.png", "scaleY": 0.5, "scaleX": 0.5 }, "compId": 230 }] }] }, { "type": "Box", "props": { "y": 112, "var": "b_baoBiao", "right": 10, "left": 347, "height": 590 }, "compId": 18, "child": [{ "type": "Image", "props": { "width": 923, "skin": "comp/dpersonalcenter_gerenzhonxinbaobiaobg.png", "sizeGrid": "86,29,29,29", "right": 0, "left": 0, "height": 513, "bottom": 0 }, "compId": 56 }, { "type": "Tab", "props": { "y": 7, "x": 1.1000000000000227, "var": "tab_1" }, "compId": 72, "child": [{ "type": "Button", "props": { "y": 0, "x": 0, "width": 214, "stateNum": 2, "skin": "comp/btn_1.png", "sizeGrid": "13,20,13,16", "scaleY": 0.85, "scaleX": 0.85, "name": "item0", "labelSize": 30, "labelColors": "#666666,#666666", "label": "棋牌平台报表", "height": 77 }, "compId": 61 }, { "type": "Button", "props": { "y": 0, "x": 185, "width": 214, "stateNum": 2, "skin": "comp/btn_1.png", "sizeGrid": "13,20,13,16", "scaleY": 0.85, "scaleX": 0.85, "name": "item1", "labelSize": 30, "labelColors": "#666666,#666666", "label": "真人视讯报表", "height": 77 }, "compId": 73 }, { "type": "Button", "props": { "y": 0, "x": 370, "width": 214, "stateNum": 2, "skin": "comp/btn_1.png", "sizeGrid": "13,20,13,16", "scaleY": 0.85, "scaleX": 0.85, "name": "item2", "labelSize": 30, "labelColors": "#666666,#666666", "label": "电子游艺报表", "height": 77 }, "compId": 75 }, { "type": "Button", "props": { "y": 0, "x": 555, "width": 214, "stateNum": 2, "skin": "comp/btn_1.png", "sizeGrid": "13,20,13,16", "scaleY": 0.85, "scaleX": 0.85, "name": "item3", "labelSize": 30, "labelColors": "#666666,#666666", "label": "体育平台报表", "height": 77 }, "compId": 76 }, { "type": "Button", "props": { "y": 0, "x": 740, "width": 214, "stateNum": 2, "skin": "comp/btn_1.png", "sizeGrid": "13,20,13,16", "scaleY": 0.85, "scaleX": 0.85, "name": "item4", "labelSize": 30, "labelColors": "#666666,#666666", "label": "捕鱼平台报表", "height": 77 }, "compId": 77 }] }, { "type": "Label", "props": { "y": 105, "x": 40, "text": "时间设置:", "fontSize": 30, "color": "#666666" }, "compId": 78 }, { "type": "Image", "props": { "y": 98.5, "x": 231, "skin": "comp/dpersonalcenter_gerenzhonxinpingtai.png" }, "compId": 79 }, { "type": "Label", "props": { "y": 104, "x": 259, "width": 130, "var": "txt_time", "text": "今天", "height": 30, "fontSize": 30, "color": "#666666", "align": "center" }, "compId": 80 }, { "type": "Label", "props": { "y": 213, "width": 128, "text": "盈利总额:", "pivotY": 15, "pivotX": 64, "height": 30, "fontSize": 30, "color": "#3d342b", "centerX": -70 }, "compId": 82 }, { "type": "Image", "props": { "y": 268, "x": 0, "skin": "comp/dpersonalcenter_gerenzhonxinline.png" }, "compId": 83 }, { "type": "Label", "props": { "y": 193, "width": 288, "var": "txt_ylze", "text": "0", "height": 35, "fontSize": 36, "color": "#008000", "centerX": 152, "bold": true, "align": "left" }, "compId": 84 }, { "type": "Image", "props": { "y": 412, "x": 0, "width": 307, "skin": "comp/dpersonalcenter_gerenzhonxinyouxiaotouzhubg.png" }, "compId": 85 }, { "type": "Image", "props": { "y": 412, "x": 309, "width": 307, "skin": "comp/dpersonalcenter_gerenzhonxinyouxiaotouzhubg.png" }, "compId": 86 }, { "type": "Image", "props": { "y": 412, "x": 617, "width": 307, "skin": "comp/dpersonalcenter_gerenzhonxinyouxiaotouzhubg.png" }, "compId": 88 }, { "type": "Image", "props": { "y": 273, "x": 307, "width": 2, "skin": "comp/dpersonalcenter_gerenzhonxinline2.png", "height": 198 }, "compId": 90 }, { "type": "Image", "props": { "y": 273, "x": 615, "width": 2, "skin": "comp/dpersonalcenter_gerenzhonxinline2.png", "height": 198 }, "compId": 92 }, { "type": "Label", "props": { "y": 426.5, "x": 78.3349609375, "text": "有效投注总额", "fontSize": 28, "color": "#ffffff" }, "compId": 93 }, { "type": "Label", "props": { "y": 426.5, "x": 378.05, "text": "有效投注总额", "fontSize": 28, "color": "#ffffff" }, "compId": 94 }, { "type": "Label", "props": { "y": 427.5, "x": 686.5, "text": "有效投注总额", "fontSize": 28, "color": "#ffffff" }, "compId": 95 }, { "type": "Label", "props": { "y": 333.5, "x": 151.650390625, "var": "txt_yxtz", "text": "0", "fontSize": 30, "color": "#ffff00", "bold": true }, "compId": 96 }, { "type": "Label", "props": { "y": 333.5, "x": 444.8154296875, "text": "0", "fontSize": 30, "color": "#ffff00", "bold": true }, "compId": 97 }, { "type": "Label", "props": { "y": 333.5, "x": 753.8154296875, "text": "0", "fontSize": 30, "color": "#ffff00", "bold": true }, "compId": 98 }] }, { "type": "Box", "props": { "y": 0, "x": 0, "var": "b_title", "right": 0, "left": 0, "height": 120 }, "compId": 104, "child": [{ "type": "Image", "props": { "top": 0, "skin": "bgs/ic_home_top_bg.png", "right": 0, "left": 0, "height": 120 }, "compId": 106 }, { "type": "Button", "props": { "y": 4, "x": 0, "var": "btn_close", "stateNum": 1, "skin": "btns/back_btn.png", "scaleY": 0.85, "scaleX": 0.85 }, "compId": 107 }, { "type": "Image", "props": { "x": 329, "skin": "bgs/ic_cus_title.png", "scaleY": 0.5, "scaleX": 0.5, "centerY": 0 }, "compId": 108 }] }, { "type": "List", "props": { "y": 0, "x": 0, "width": 295, "var": "list_tab", "top": 125, "spaceY": 5, "repeatY": 5, "repeatX": 1, "left": 0, "height": 578 }, "compId": 105, "child": [{ "type": "Box", "props": { "renderType": "render" }, "compId": 109, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 287, "skin": "btns/ic_pc_grxx.png", "name": "bg_normal", "height": 96 }, "compId": 110 }, { "type": "Image", "props": { "y": 0, "x": 0, "width": 287, "skin": "btns/ic_pc_grxx_pressed.png", "name": "bg_selected", "height": 96 }, "compId": 111 }] }] }, { "type": "Box", "props": { "var": "b_vipInfo" }, "compId": 231 }], "loadList": ["bgs/ic_qipai_bg.png", "comp/dactivity_nav_left.png", "bgs/ic_pc_title.png", "icons/ic_dot.png", "icons/ic_pc_vip1.png", "icons/ic_vip_1.png", "comp/progress_load_drawable.png", "comp/progress_load_bg_select.png", "bgs/vip_title_bg.png", "icons/ic_up_vip1.png", "icons/ic_next_vip2.png", "bgs/pc_quanyi_bg.png", "icons/rights_1.png", "btns/ic_act_no.png", "icons/rights_3.png", "icons/rights_2.png", "icons/rights_4.png", "btns/ic_xima_shoudongxima.png", "btns/ic_edit.png", "comp/img_touxiangMask.png", "comp/dindex_index_icon.png", "comp/ic_input_bg.png", "bgs/ic_gathering_bg.png", "comp/vscroll.png", "bgs/dpersonalcenter_gerenzhonxinjilubg1.png", "bgs/dpersonalcenter_gerenzhonxinjilubg2.png", "btns/ic_pc_grbb_tab.png", "btns/ic_pc_grbb_tab_pressed.png", "bgs/ic_pc_edit.png", "bgs/ic_pc_pop_wind.png", "comp/bg_data_null.png", "comp/dpersonalcenter_gerenzhonxinbaobiaobg.png", "comp/btn_1.png", "comp/dpersonalcenter_gerenzhonxinpingtai.png", "comp/dpersonalcenter_gerenzhonxinline.png", "comp/dpersonalcenter_gerenzhonxinyouxiaotouzhubg.png", "comp/dpersonalcenter_gerenzhonxinline2.png", "bgs/ic_home_top_bg.png", "btns/back_btn.png", "bgs/ic_cus_title.png", "btns/ic_pc_grxx.png", "btns/ic_pc_grxx_pressed.png"], "loadList3D": [] };
        return UserInfoUI;
    }(View));
