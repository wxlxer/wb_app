module gamelib.control {
	...
	export class HallCommonBtns
	{
		...
		private getVisible(data_source:any,key:string):boolean
		{
			if(data_source == null)
				return false;
			var pf_data:any = data_source[key];
			if(pf_data == null)
				return false;
			...
			var gameid:any = pf_data.gameid;

			var not_gz_id:Array<number> = pf_data.not_gz_id;
			if(gameid == "all")
			{
