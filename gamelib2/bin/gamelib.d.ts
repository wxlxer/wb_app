...
declare namespace gamelib.core {
    ...
    class BaseUi extends Laya.Script {
        ...
        */
        ...
        private changeResource(temp);
        private getNewSkin(url);
    }
}
...
declare module gamelib.Api {
     ...
     * @param callback
     */
    function checkPlatfromMoney(callback?: Laya.Handler): void;
    /**
     * 更新玩家信息
     * @function
    ...
    function buyItem(buyindex: number, callBack?: Laya.Handler, num?: number, extra_data?: any): void;
    /**
     * 获得商城道具
     * @function
...
declare module gamelib {
    ...
    class GameMsg {
         ...
         * @static
         */
        static CHANGELAN: string;
        /** @type {物品模式数据载入完成} [description] */
        static GOODSMSIDDATALOADED: string;
        /**
         * 播放获得道具的特效
         */
        static PLAYGETITEMEFFECT: string;
        /**
         * 刷新平台数据
         */
        static REFRESHPLATFORMDATA: string;
    }
}
declare module gamelib.core {
    /**
    ...
    class GameNet {
        ...
        private _send0x00B6;
        private _isChild;
        private _gameProtocols;
        constructor(name: string, isChild: boolean);
        setGameProtocols(protocols: any): void;
...
declare function isMultipleLans(): boolean;
...
declare namespace gamelib.core {
    ...
    class Resources {
         ...
         */
        registrerFont(): void;
        destroyAllRes(game_code: string): void;
        destroy(): void;
        next(): void;
        /**
         * 载入ui.json文件
...
declare module gamelib.chat {
    ...
    class ChatPanel extends gamelib.core.BaseUi {
         ...
         * @param {boolean} value [description]
         */
        setQuickTalkEnabled(value: boolean): void;
        /**
         * 设置 表情是否可用
         * @function
...
declare module gamelib.control {
    ...
    class MyPersonalInfo extends gamelib.core.Ui_NetHandle {
        ...
        updatePlayerData(pd: gamelib.data.UserInfo): void;
        destroy(): void;
        protected onShow(): void;
        private setValues();
        protected onClose(): void;
...
declare module gamelib.common {
    ...
    class DistanceCheck {
         ...
         */
        checkInStart(okCallBack: Laya.Handler): boolean;
...
declare module gamelib.common {
    ...
    class DistanceCheckUi extends gamelib.core.BaseUi {
        ...
        constructor();
        protected init(): void;
        setPlayerList(list: Array<gamelib.data.UserInfo>, okHandler?: Laya.Handler): void;
...
declare namespace gamelib.common {
    class MailUi2 extends gamelib.core.Ui_NetHandle {
        private _list;
        private _itemList;
        private _time;
        private _sender;
        ...
        private _ylq;
        private _tips;
        private _currentMail;
        constructor();
        reciveNetMsg(msgId: number, data: any): void;
        protected onShow(): void;
        protected refreshList(changeIndexToZero?: boolean): void;
        protected onClickObjects(evt: Laya.Event): void;
        protected init(): void;
        private onMailListRender(box, index);
        private removeMaile(md);
        private onItemListRender(box, index);
        private onSelecteChange();
    }
}
...
declare module gamelib.data {
    ...
    class MailData extends GameData {
         ...
         */
        static GetItems(md: MailData | Array<MailData>): Array<{
            msId: number;
            num: number;
        }>;
        static AllRead(): void;
...
declare namespace gamelib.data {
    class MathData extends gamelib.data.GameData {
        type: number;
        constructor();
        static s_list: Array<MathData>;
        static ParseList(data: any): void;
        static GetMatchDataById(id: number, type?: number): MathData;
    }
}
/**
 * Created by wxlan on 2017/9/4.
...
declare module gamelib.data {
    ...
    class UserInfo extends GameData {
         ...
         */
        getDistance(user: data.UserInfo): string;
        /**
         *
         * @param user
         * @return -1：没有距离信息，其他值，单位米
         */
        getDistanceNum(user: data.UserInfo): number;
    }
}
...
declare namespace gamelib.platform {
     ...
     */
    function shareApp(callBack?: Function, thisobj?: any, wx_firendCircle?: boolean, extra_data?: any): void;
}
